...
| ------- | ----------------- | ------------- | -------- | --------------- | ------ | ---- | ------- |
| E0 | status 0.40 / method 0.40 | earliest-exact 0.36 | ev_err 11 | cons_err 0 | 0 | 0.00 | 2.06s |
| E1 | status 0.44 / method 0.48 | earliest-exact 0.36 | ev_err 11 | cons_err 0 | 0 | 0.00 | 4.63s |
| E2 | status 0.44 / method 0.48 | earliest-exact 0.36 | ev_err 0 | cons_err 0 | 0 | 0.00 | 2.0s |
...
| E7 +token accounting | 0 calls / 0 tokens at equal accuracy; runtime 2.0s | 0 | 0 | KEEP |
...
- E7 tokens: 0 calls, 0 tokens, 2.0s for 250 requests. image resolution only for blank amounts (16); message interpreter deterministic-only; LLM off by default
